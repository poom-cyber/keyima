...
async function sendOrderConfirmation(o) {
  ...
  const payNote = o.slip ? "" : `\n\n⏰ กรุณาชำระเงินและแนบสลิปภายใน 3 ชั่วโมง มิฉะนั้นออเดอร์จะถูกยกเลิกอัตโนมัติ\nแนบสลิปได้ที่หน้า "ติดตามคำสั่งซื้อ" บนเว็บไซต์`;
  const text = `สวัสดีคุณ ${o.name}\n\nขอบคุณที่สั่งซื้อกับ ${SHOP} 🌸\nนี่คือ${hasPre ? "ใบพรีออเดอร์" : "ใบยืนยันคำสั่งซื้อ"}ของคุณ\n\n${orderLines(o)}${payNote}\n\nเราจะแจ้งความคืบหน้าทางอีเมลนี้\nขอบคุณครับ/ค่ะ\n${SHOP}`;
