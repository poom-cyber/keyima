...
const AdminAPI = {
  base() {
    // โปรดักชัน: เสิร์ฟหน้าแอดมินแบบ same-origin ใต้ /admin เสมอ — ไม่พึ่ง localStorage เก่าที่อาจชี้ localhost
    if (!ADMIN_IS_LOCAL) return location.origin + "/admin";
    return localStorage.getItem("kps_api_base") || "http://localhost:4000";
  },
