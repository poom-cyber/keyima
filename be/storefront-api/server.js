...
const ORIGINS = (process.env.STOREFRONT_ORIGINS || "http://localhost:8080").split(",");
...
app.get("/api/settings", (_q, res) => {
  ...
  res.json({ shopName: s.shopName, promo: s.promo, shippingFlat: s.shippingFlat, freeShipMin: s.freeShipMin });
});
